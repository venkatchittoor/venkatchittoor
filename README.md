...
|---|---|---|---|
| [sales-intelligence-pipeline](https://github.com/venkatchittoor/sales-intelligence-pipeline) | Data Engineering | Pipeline | Built entirely via Claude Code — no manual code written |
| [ecommerce-pipeline](https://github.com/venkatchittoor/ecommerce-pipeline) | Data Engineering | Pipeline | 6-phase production stack — streaming, DLT, NL querying, scheduled jobs |
| [iceberg-lakehouse-comparison](https://github.com/venkatchittoor/iceberg-lakehouse-comparison) | Data Engineering | Comparison | Same pipeline built twice — Delta Lake vs Apache Iceberg side-by-side |
| [data-incident-agent](https://github.com/venkatchittoor/data-incident-agent) | Agentic AI | Prompt-based | Monitoring only — never acts, reports and escalates with reasoning |
| [pricing-decision-agent](https://github.com/venkatchittoor/pricing-decision-agent) | Agentic AI | Prompt-based | Confidence-gated autonomy — HIGH acts instantly, MEDIUM/LOW defers to human |
| [customer-behavior-crew](https://github.com/venkatchittoor/customer-behavior-crew) | Agentic AI | Prompt-based crew | LLM-driven routing via agent registry — extensible by addition |
| [drilling-npt-agent](https://github.com/venkatchittoor/drilling-npt-agent) | Agentic AI + O&G | Prompt-based | 20 years of drilling expertise encoded in prompts — not hardcoded rules |
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=flat&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/venkatchittoor)
[![GitHub](https://img.shields.io/badge/GitHub-181717?style=flat&logo=github&logoColor=white)](https://github.com/venkatchittoor)
